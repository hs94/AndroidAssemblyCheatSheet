...
public class JrClass extends Activity {

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_jr_class);
		String text = "jr rs" + "\n" + "Result: PC = rs";
		TextView add = (TextView) findViewById (R.id.mips_jr);
		add.setText(text);
	}
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.jr_class, menu);
		return true;
	}
