...
public class MIPSJumpList extends ListActivity {

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		String[] classes = new String[] {"b","beq","bne","beqz","bnez","bgez","bgtz","blez"
				,"bltz","j","jal","jr"};
	...
	protected void onListItemClick(ListView l, View v, int position, long id) {
		...
		try
		{
			...
			Intent i = new Intent (MIPSJumpList.this, command);
			startActivity(i);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.mipsjump_list, menu);
		return true;
	}
