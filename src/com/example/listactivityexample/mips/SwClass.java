...
public class SwClass extends Activity {

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_sw_class);
		String text = "sw \t rd, off16(rs)" + "\n" + "Result: store contents of rs + off16 in rd";
		TextView add = (TextView) findViewById (R.id.mips_sw);
		add.setText(text);
	}
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.sw_class, menu);
		return true;
	}
