...
public class MIPSLogicalList extends ListActivity {

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		String[] classes = new String[] {"and", "andi", "or", "ori", "nor", "xor"};
	...
	protected void onListItemClick(ListView l, View v, int position, long id) {
		...
		try
		{
			...
			Intent i = new Intent (MIPSLogicalList.this, command);
			startActivity(i);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.mipslogical_list, menu);
		return true;
	}
