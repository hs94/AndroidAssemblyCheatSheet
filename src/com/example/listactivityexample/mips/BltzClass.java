...
public class BltzClass extends Activity {

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_bltz_class);
		String text = "bltz \t rs, off18" + "\n" + "Result: PC = PC + off18 if rs < 0";
		TextView add = (TextView) findViewById (R.id.mips_bltz);
		add.setText(text);
	}
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.bltz_class, menu);
		return true;
	}
