...
public class MIPSLoadStoreList extends ListActivity {

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		//setContentView(R.layout.activity_mipsload_store_list);
		String[] classes = new String[] {"lw", "la", "li", "lb", "lh", "sw", "sb", "sh"};
	...
	protected void onListItemClick(ListView l, View v, int position, long id) {
		...
		try
		{
			...
			Intent i = new Intent (MIPSLoadStoreList.this, command);
			startActivity(i);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.mipsload_store_list, menu);
		return true;
	}
