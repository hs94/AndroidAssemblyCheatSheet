...
import com.example.listactivityexample.CommandsList;
...
public class MIPSArithmeticList extends ListActivity {

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		String[] classes = new String[] {"add", "addi", "addu", "sub", "subi", "subu", "move"};
	...
	protected void onListItemClick(ListView l, View v, int position, long id) {
		...
		try
		{
			...
			Intent i = new Intent (MIPSArithmeticList.this, command);
			startActivity(i);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.mipsarithmetic_list, menu);
		return true;
	}
