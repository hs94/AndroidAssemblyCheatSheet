...
public class MulClass extends Activity {

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_mul_class);
		String text = "mul \t rd, rs, rt" + "\n" + "Result: rd = rs * rt ";
		TextView add = (TextView) findViewById (R.id.mips_mul);
		add.setText(text);
	}
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.mul_class, menu);
		return true;
	}
