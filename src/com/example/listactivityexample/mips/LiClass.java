...
public class LiClass extends Activity {

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_li_class);
		String text = "li \t rd, imm32" + "\n" + "Result: rd = imm32";
		TextView add = (TextView) findViewById (R.id.mips_li);
		add.setText(text);
	}
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.li_class, menu);
		return true;
	}
