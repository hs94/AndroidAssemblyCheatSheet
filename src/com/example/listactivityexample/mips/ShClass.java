...
public class ShClass extends Activity {

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_sh_class);
		String text = "sh \t rd, off16(rs)" + "\n" + "Result: store sign-extended 16-bit quantity in rs + off16 in rd ";
		TextView add = (TextView) findViewById (R.id.mips_sh);
		add.setText(text);
	}
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.sh_class, menu);
		return true;
	}
