...
public class BnezClass extends Activity {

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_bnez_class);
		String text = "bnez \t rs, off18" + "\n" + "Result: PC = PC + off18 if rs != 0";
		TextView add = (TextView) findViewById (R.id.mips_bnez);
		add.setText(text);
	}
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.bnez_class, menu);
		return true;
	}
