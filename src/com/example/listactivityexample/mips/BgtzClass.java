...
public class BgtzClass extends Activity {

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_bgtz_class);
		String text = "bgtz \t rs, off18" + "\n" + "Result: PC = PC + off18 if rs > 0";
		TextView add = (TextView) findViewById (R.id.mips_bgtz);
		add.setText(text);
	}
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.bgtz_class, menu);
		return true;
	}
